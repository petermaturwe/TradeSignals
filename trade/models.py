...
class TradeSignal(models.Model):
    ...
    take_profit = models.DecimalField(max_digits=20, decimal_places=10, null=True, default=None)
    stop_loss = models.DecimalField(max_digits=20, decimal_places=10, null=True, default=None)
